...
export default {
  async init(scene, title, subtitle, width, height) {
    console.log("TEXT.init called with:", { title, subtitle, width, height });
    if (advancedTexture) {
  ...
  render() {
    ...
    // QR code stays in Bottom Right corner
    const qrSize = 180 * currentScale;
